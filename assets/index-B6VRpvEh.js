 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xd;function Tm(){return Xd||(Xd=1,(function(r){function E(j,U){var W=j.length;j.push(U);n:for(;0<W;){var sn=W-1>>>1,En=j[sn];if(0<A(En,U))j[sn]=U,j[W]=En,W=sn;else break n}}function h(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var U=j[0],W=j.pop();if(W!==U){j[0]=W;n:for(var sn=0,En=j.length,g=En>>>1;sn<g;){var _=2*(sn+1)-1,N=j[_],k=_+1,$=j[k];if(0>A(N,W))k<En&&0>A($,N)?(j[sn]=$,j[k]=W,sn=k):(j[sn]=N,j[_]=W,sn=_);else if(k<En&&0>A($,W))j[sn]=$,j[k]=W,sn=k;else break n}}return U}function A(j,U){var W=j.sortIndex-U.sortIndex;return W!==0?W:j.id-U.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;r.unstable_now=function(){return O.now()}}else{var B=Date,H=B.now();r.unstable_now=function(){return B.now()-H}}var R=[],x=[],V=1,C=null,F=3,J=!1,yn=!1,tn=!1,cn=!1,D=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function L(j){for(var U=h(x);U!==null;){if(U.callback===null)s(x);else if(U.startTime<=j)s(x),U.sortIndex=U.expirationTime,E(R,U);else break;U=h(x)}}function pn(j){if(tn=!1,L(j),!yn)if(h(R)!==null)yn=!0,jn||(jn=!0,Hn());else{var U=h(x);U!==null&&yt(pn,U.startTime-j)}}var jn=!1,w=-1,Cn=5,Wn=-1;function Mn(){return cn?!0:!(r.unstable_now()-Wn<Cn)}function In(){if(cn=!1,jn){var j=r.unstable_now();Wn=j;var U=!0;try{n:{yn=!1,tn&&(tn=!1,Y(w),w=-1),J=!0;var W=F;try{t:{for(L(j),C=h(R);C!==null&&!(C.expirationTime>j&&Mn());){var sn=C.callback;if(typeof sn=="function"){C.callback=null,F=C.priorityLevel;var En=sn(C.expirationTime<=j);if(j=r.unstable_now(),typeof En=="function"){C.callback=En,L(j),U=!0;break t}C===h(R)&&s(R),L(j)}else s(R);C=h(R)}if(C!==null)U=!0;else{var g=h(x);g!==null&&yt(pn,g.startTime-j),U=!1}}break n}finally{C=null,F=W,J=!1}U=void 0}}finally{U?Hn():jn=!1}}}var Hn;if(typeof Z=="function")Hn=function(){Z(In)};else if(typeof MessageChannel<"u"){var Ot=new MessageChannel,on=Ot.port2;Ot.port1.onmessage=In,Hn=function(){on.postMessage(null)}}else Hn=function(){D(In,0)};function yt(j,U){w=D(function(){j(r.unstable_now())},U)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Cn=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return F},r.unstable_next=function(j){switch(F){case 1:case 2:case 3:var U=3;break;default:U=F}var W=F;F=U;try{return j()}finally{F=W}},r.unstable_requestPaint=function(){cn=!0},r.unstable_runWithPriority=function(j,U){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var W=F;F=j;try{return U()}finally{F=W}},r.unstable_scheduleCallback=function(j,U,W){var sn=r.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?sn+W:sn):W=sn,j){case 1:var En=-1;break;case 2:En=250;break;case 5:En=1073741823;break;case 4:En=1e4;break;default:En=5e3}return En=W+En,j={id:V++,callback:U,priorityLevel:j,startTime:W,expirationTime:En,sortIndex:-1},W>sn?(j.sortIndex=W,E(x,j),h(R)===null&&j===h(x)&&(tn?(Y(w),w=-1):tn=!0,yt(pn,W-sn))):(j.sortIndex=En,E(R,j),yn||J||(yn=!0,jn||(jn=!0,Hn()))),j},r.unstable_shouldYield=Mn,r.unstable_wrapCallback=function(j){var U=F;return function(){var W=F;F=U;try{return j.apply(this,arguments)}finally{F=W}}}})(Qo)),Qo}var Vd;function zm(){return Vd||(Vd=1,ko.exports=Tm()),ko.exports}var Xo={exports:{}},ft={};/**
 * @license React
...
## [Android 版本更新](/changelog/android)

最新版本：v2.6.5 | 应用宝、华为、小米等渠道下载

---

## [HarmonyOS 版本更新](/changelog/harmonyos)
