(function(){const E=document.createElement("link").relList;if(E&&E.supports&&E.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))s(A);new MutationObserver(A=>{for(const O of A)if(O.type==="childList")for(const B of O.addedNodes)B.tagName==="LINK"&&B.rel==="modulepreload"&&s(B)}).observe(document,{childList:!0,subtree:!0});function h(A){const O={};return A.integrity&&(O.integrity=A.integrity),A.referrerPolicy&&(O.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?O.credentials="include":A.crossOrigin==="anonymous"?O.credentials="omit":O.credentials="same-origin",O}function s(A){if(A.ep)return;A.ep=!0;const O=h(A);fetch(A.href,O)}})();function Sm(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var qo={exports:{}},ai={};/**
 * @license React
 ...
 */var Ld;function Am(){if(Ld)return ai;Ld=1;var r=Symbol.for("react.transitional.element"),E=Symbol.for("react.fragment");function h(s,A,O){var B=null;if(O!==void 0&&(B=""+O),A.key!==void 0&&(B=""+A.key),"key"in A){O={};for(var H in A)H!=="key"&&(O[H]=A[H])}else O=A;return A=O.ref,{$$typeof:r,type:s,key:B,ref:A!==void 0?A:null,props:O}}return ai.Fragment=E,ai.jsx=h,ai.jsxs=h,ai}var Yd;function jm(){return Yd||(Yd=1,qo.exports=Am()),qo.exports}var o=jm(),Lo={exports:{}},nn={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kd;function Em(){if(kd)return nn;kd=1;var r=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),h=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),O=Symbol.for("react.consumer"),B=Symbol.for("react.context"),H=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),F=Symbol.iterator;function J(g){return g===null||typeof g!="object"?null:(g=F&&g[F]||g["@@iterator"],typeof g=="function"?g:null)}var yn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},tn=Object.assign,cn={};function D(g,M,N){this.props=g,this.context=M,this.refs=cn,this.updater=N||yn}D.prototype.isReactComponent={},D.prototype.setState=function(g,M){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,M,"setState")},D.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Y(){}Y.prototype=D.prototype;function Z(g,M,N){this.props=g,this.context=M,this.refs=cn,this.updater=N||yn}var L=Z.prototype=new Y;L.constructor=Z,tn(L,D.prototype),L.isPureReactComponent=!0;var pn=Array.isArray;function jn(){}var w={H:null,A:null,T:null,S:null},Cn=Object.prototype.hasOwnProperty;function Wn(g,M,N){var k=N.ref;return{$$typeof:r,type:g,key:M,ref:k!==void 0?k:null,props:N}}function _n(g,M){return Wn(g.type,M,g.props)}function In(g){return typeof g=="object"&&g!==null&&g.$$typeof===r}function Hn(g){var M={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(N){return M[N]})}var Ot=/\/+/g;function on(g,M){return typeof g=="object"&&g!==null&&g.key!=null?Hn(""+g.key):M.toString(36)}function yt(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(jn,jn):(g.status="pending",g.then(function(M){g.status==="pending"&&(g.status="fulfilled",g.value=M)},function(M){g.status==="pending"&&(g.status="rejected",g.reason=M)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function j(g,M,N,k,$){var un=typeof g;(un==="undefined"||un==="boolean")&&(g=null);var vn=!1;if(g===null)vn=!0;else switch(un){case"bigint":case"string":case"number":vn=!0;break;case"object":switch(g.$$typeof){case r:case E:vn=!0;break;case V:return vn=g._init,j(vn(g._payload),M,N,k,$)}}if(vn)return $=$(g),vn=k===""?"."+on(g,0):k,pn($)?(N="",vn!=null&&(N=vn.replace(Ot,"$&/")+"/"),j($,M,N,"",function(Ze){return Ze})):$!=null&&(In($)&&($=_n($,N+($.key==null||g&&g.key===$.key?"":(""+$.key).replace(Ot,"$&/")+"/")+vn)),M.push($)),1;vn=0;var Pn=k===""?".":k+":";if(pn(g))for(var wn=0;wn<g.length;wn++)k=g[wn],un=Pn+on(k,wn),vn+=j(k,M,N,un,$);else if(wn=J(g),typeof wn=="function")for(g=wn.call(g),wn=0;!(k=g.next()).done;)k=k.value,un=Pn+on(k,wn++),vn+=j(k,M,N,un,$);else if(un==="object"){if(typeof g.then=="function")return j(yt(g),M,N,k,$);throw M=String(g),Error("Objects are not valid as a React child (found: "+(M==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":M)+"). If you meant to render a collection of children, use an array instead.")}return vn}function U(g,M,N){if(g==null)return g;var k=[],$=0;return j(g,k,"","",function(un){return M.call(N,un,$++)}),k}function W(g){if(g._status===-1){var M=g._result;M=M(),M.then(function(N){(g._status===0||g._status===-1)&&(g._status=1,g._result=N)},function(N){(g._status===0||g._status===-1)&&(g._status=2,g._result=N)}),g._status===-1&&(g._status=0,g._result=M)}if(g._status===1)return g._result.default;throw g._result}var sn=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var M=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(M))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},En={map:U,forEach:function(g,M,N){U(g,function(){M.apply(this,arguments)},N)},count:function(g){var M=0;return U(g,function(){M++}),M},toArray:function(g){return U(g,function(M){return M})||[]},only:function(g){if(!In(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return nn.Activity=C,nn.Children=En,nn.Component=D,nn.Fragment=h,nn.Profiler=A,nn.PureComponent=Z,nn.StrictMode=s,nn.Suspense=R,nn.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=w,nn.__COMPILER_RUNTIME={__proto__:null,c:function(g){return w.H.useMemoCache(g)}},nn.cache=function(g){return function(){return g.apply(null,arguments)}},nn.cacheSignal=function(){return null},nn.cloneElement=function(g,M,N){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var k=tn({},g.props),$=g.key;if(M!=null)for(un in M.key!==void 0&&($=""+M.key),M)!Cn.call(M,un)||un==="key"||un==="__self"||un==="__source"||un==="ref"&&M.ref===void 0||(k[un]=M[un]);var un=arguments.length-2;if(un===1)k.children=N;else if(1<un){for(var vn=Array(un),Pn=0;Pn<un;Pn++)vn[Pn]=arguments[Pn+2];k.children=vn}return Wn(g.type,$,k)},nn.createContext=function(g){return g={$$typeof:B,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:O,_context:g},g},nn.createElement=function(g,M,N){var k,$={},un=null;if(M!=null)for(k in M.key!==void 0&&(un=""+M.key),M)Cn.call(M,k)&&k!=="key"&&k!=="__self"&&k!=="__source"&&($[k]=M[k]);var vn=arguments.length-2;if(vn===1)$.children=N;else if(1<vn){for(var Pn=Array(vn),wn=0;wn<vn;wn++)Pn[wn]=arguments[wn+2];$.children=Pn}if(g&&g.defaultProps)for(k in vn=g.defaultProps,vn)$[k]===void 0&&($[k]=vn[k]);return Wn(g,un,$)},nn.createRef=function(){return{current:null}},nn.forwardRef=function(g){return{$$typeof:H,render:g}},nn.isValidElement=In,nn.lazy=function(g){return{$$typeof:V,_payload:{_status:-1,_result:g},_init:W}},nn.memo=function(g,M){return{$$typeof:x,type:g,compare:M===void 0?null:M}},nn.startTransition=function(g){var M=w.T,N={};w.T=N;try{var k=g(),$=w.S;$!==null&&$(N,k),typeof k=="object"&&k!==null&&typeof k.then=="function"&&k.then(jn,sn)}catch(un){sn(un)}finally{M!==null&&N.types!==null&&(M.types=N.types),w.T=M}},nn.unstable_useCacheRefresh=function(){return w.H.useCacheRefresh()},nn.use=function(g){return w.H.use(g)},nn.useActionState=function(g,M,N){return w.H.useActionState(g,M,N)},nn.useCallback=function(g,M){return w.H.useCallback(g,M)},nn.useContext=function(g){return w.H.useContext(g)},nn.useDebugValue=function(){},nn.useDeferredValue=function(g,M){return w.H.useDeferredValue(g,M)},nn.useEffect=function(g,M){return w.H.useEffect(g,M)},nn.useEffectEvent=function(g){return w.H.useEffectEvent(g)},nn.useId=function(){return w.H.useId()},nn.useImperativeHandle=function(g,M,N){return w.H.useImperativeHandle(g,M,N)},nn.useInsertionEffect=function(g,M){return w.H.useInsertionEffect(g,M)},nn.useLayoutEffect=function(g,M){return w.H.useLayoutEffect(g,M)},nn.useMemo=function(g,M){return w.H.useMemo(g,M)},nn.useOptimistic=function(g,M){return w.H.useOptimistic(g,M)},nn.useReducer=function(g,M,N){return w.H.useReducer(g,M,N)},nn.useRef=function(g){return w.H.useRef(g)},nn.useState=function(g){return w.H.useState(g)},nn.useSyncExternalStore=function(g,M,N){return w.H.useSyncExternalStore(g,M,N)},nn.useTransition=function(){return w.H.useTransition()},nn.version="19.2.4",nn}var Qd;function Jo(){return Qd||(Qd=1,Lo.exports=Em()),Lo.exports}var G=Jo();const ig=Sm(G);var Yo={exports:{}},ii={},ko={exports:{}},Qo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xd;function zm(){return Xd||(Xd=1,(function(r){function E(j,U){var W=j.length;j.push(U);n:for(;0<W;){var sn=W-1>>>1,En=j[sn];if(0<A(En,U))j[sn]=U,j[W]=En,W=sn;else break n}}function h(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var U=j[0],W=j.pop();if(W!==U){j[0]=W;n:for(var sn=0,En=j.length,g=En>>>1;sn<g;){var M=2*(sn+1)-1,N=j[M],k=M+1,$=j[k];if(0>A(N,W))k<En&&0>A($,N)?(j[sn]=$,j[k]=W,sn=k):(j[sn]=N,j[M]=W,sn=M);else if(k<En&&0>A($,W))j[sn]=$,j[k]=W,sn=k;else break n}}return U}function A(j,U){var W=j.sortIndex-U.sortIndex;return W!==0?W:j.id-U.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;r.unstable_now=function(){return O.now()}}else{var B=Date,H=B.now();r.unstable_now=function(){return B.now()-H}}var R=[],x=[],V=1,C=null,F=3,J=!1,yn=!1,tn=!1,cn=!1,D=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function L(j){for(var U=h(x);U!==null;){if(U.callback===null)s(x);else if(U.startTime<=j)s(x),U.sortIndex=U.expirationTime,E(R,U);else break;U=h(x)}}function pn(j){if(tn=!1,L(j),!yn)if(h(R)!==null)yn=!0,jn||(jn=!0,Hn());else{var U=h(x);U!==null&&yt(pn,U.startTime-j)}}var jn=!1,w=-1,Cn=5,Wn=-1;function _n(){return cn?!0:!(r.unstable_now()-Wn<Cn)}function In(){if(cn=!1,jn){var j=r.unstable_now();Wn=j;var U=!0;try{n:{yn=!1,tn&&(tn=!1,Y(w),w=-1),J=!0;var W=F;try{t:{for(L(j),C=h(R);C!==null&&!(C.expirationTime>j&&_n());){var sn=C.callback;if(typeof sn=="function"){C.callback=null,F=C.priorityLevel;var En=sn(C.expirationTime<=j);if(j=r.unstable_now(),typeof En=="function"){C.callback=En,L(j),U=!0;break t}C===h(R)&&s(R),L(j)}else s(R);C=h(R)}if(C!==null)U=!0;else{var g=h(x);g!==null&&yt(pn,g.startTime-j),U=!1}}break n}finally{C=null,F=W,J=!1}U=void 0}}finally{U?Hn():jn=!1}}}var Hn;if(typeof Z=="function")Hn=function(){Z(In)};else if(typeof MessageChannel<"u"){var Ot=new MessageChannel,on=Ot.port2;Ot.port1.onmessage=In,Hn=function(){on.postMessage(null)}}else Hn=function(){D(In,0)};function yt(j,U){w=D(function(){j(r.unstable_now())},U)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Cn=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return F},r.unstable_next=function(j){switch(F){case 1:case 2:case 3:var U=3;break;default:U=F}var W=F;F=U;try{return j()}finally{F=W}},r.unstable_requestPaint=function(){cn=!0},r.unstable_runWithPriority=function(j,U){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var W=F;F=j;try{return U()}finally{F=W}},r.unstable_scheduleCallback=function(j,U,W){var sn=r.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?sn+W:sn):W=sn,j){case 1:var En=-1;break;case 2:En=250;break;case 5:En=1073741823;break;case 4:En=1e4;break;default:En=5e3}return En=W+En,j={id:V++,callback:U,priorityLevel:j,startTime:W,expirationTime:En,sortIndex:-1},W>sn?(j.sortIndex=W,E(x,j),h(R)===null&&j===h(x)&&(tn?(Y(w),w=-1):tn=!0,yt(pn,W-sn))):(j.sortIndex=En,E(R,j),yn||J||(yn=!0,jn||(jn=!0,Hn()))),j},r.unstable_shouldYield=_n,r.unstable_wrapCallback=function(j){var U=F;return function(){var W=F;F=U;try{return j.apply(this,arguments)}finally{F=W}}}})(Qo)),Qo}var Vd;function Tm(){return Vd||(Vd=1,ko.exports=zm()),ko.exports}var Xo={exports:{}},ft={};/**
 * @license React
...
<a href="./ios" style="display: block; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px; text-decoration: none; color: inherit; transition: box-shadow 0.2s;">
  <div style="font-size: 1.5em; margin-bottom: 8px;">iOS</div>
  <div style="color: #6b7280; font-size: 0.9em;">最新版本：v2.6.5</div>
  <div style="color: #9ca3af; font-size: 0.85em; margin-top: 4px;">App Store 下载</div>
</a>

<a href="./android" style="display: block; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px; text-decoration: none; color: inherit; transition: box-shadow 0.2s;">
  <div style="font-size: 1.5em; margin-bottom: 8px;">Android</div>
  <div style="color: #6b7280; font-size: 0.9em;">最新版本：v2.6.5</div>
  <div style="color: #9ca3af; font-size: 0.85em; margin-top: 4px;">应用宝、华为、小米等渠道下载</div>
</a>

<a href="./harmonyos" style="display: block; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px; text-decoration: none; color: inherit; transition: box-shadow 0.2s;">
  <div style="font-size: 1.5em; margin-bottom: 8px;">HarmonyOS</div>
  <div style="color: #6b7280; font-size: 0.9em;">最新版本：v2.6.5</div>
  <div style="color: #9ca3af; font-size: 0.85em; margin-top: 4px;">华为应用市场下载</div>
</a>
...
![手机相机拍摄界面，对准一本纸质书的书页内容进行拍照，页面底部显示「重拍」和「使用照片」两个操作按钮](/getbi`}],m1={};function h1({samples:r}){var s;const[E,h]=G.useState(0);return r.length===0?null:o.jsxs("div",{"data-testid":"code-samples",style:{border:"1px solid var(--bd)",borderRadius:8,overflow:"hidden"},children:[o.jsx("div",{style:{display:"flex",borderBottom:"1px solid var(--bd)",background:"var(--sf)",overflowX:"auto",WebkitOverflowScrolling:"touch"},children:r.map((A,O)=>o.jsx("button",{onClick:()=>h(O),style:{padding:"8px 16px",fontSize:13,fontWeight:500,background:O===E?"var(--cdBg)":"transparent",color:O===E?"var(--tx)":"var(--tx2)",border:"none",borderBottom:O===E?"2px solid var(--ac)":"2px solid transparent",cursor:"pointer",fontFamily:"var(--font-body)",whiteSpace:"nowrap"},children:A.label},A.language))}),o.jsx("pre",{style:{margin:0,padding:16,background:"var(--cdBg)",overflow:"auto"},children:o.jsx("code",{style:{fontSize:13,fontFamily:"var(--font-code)"},children:(s=r[E])==null?void 0:s.code})})]})}function p1({href:r,title:E,description:h,icon:s,external:A}){const O=A??r.startsWith("http");return o.jsxs("a",{href:r,target:O?"_blank":void 0,rel:O?"noopener noreferrer":void 0,style:{display:"block",padding:"16px 20px",border:"1px solid var(--bd)",borderRadius:8,textDecoration:"none",color:"inherit",background:"var(--sf)",transition:"border-color 0.15s, background 0.15s",cursor:"pointer"},onMouseEnter:B=>{B.currentTarget.style.borderColor="var(--ac)",B.currentTarget.style.background="var(--sfH)"},onMouseLeave:B=>{B.currentTarget.style.borderColor="var(--bd)",B.currentTarget.style.background="var(--sf)"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s&&o.jsx("span",{style:{fontSize:18},children:s}),o.jsx("span",{style:{fontWeight:600,fontSize:15,color:"var(--tx)"},children:E}),o.jsx("span",{style:{marginLeft:"auto",color:"var(--tx2)",fontSize:14},children:O?"↗":"→"})]}),h&&o.jsx("p",{style:{margin:"6px 0 0",fontSize:13,color:"var(--tx2)",lineHeight:1.5},children:h})]})}function v1({columns:r=2,children:E}){return o.jsx("div",{style:{display:"grid",gridTemplateColumns:`repeat(${r}, 1fr)`,gap:12,marginTop:16,marginBottom:16},children:E})}const b1={Added:"#22c55e",Changed:"#3b82f6",Deprecated:"#f59e0b",Removed:"#ef4444",Fixed:"#8b5cf6",Security:"#f97316"};function eg(r){return b1[r]||"#6b7280"}function y1({entries:r,initialLimit:E}){const[h,s]=G.useState(!E),A=h?r:r.slice(0,E||r.length);return r.length===0?o.jsx("div",{"data-testid":"changelog-empty",style:{padding:"40px 0",textAlign:"center",color:"var(--txM)",fontSize:14},children:"No changelog entries found."}):o.jsxs("div",{"data-testid":"changelog-timeline",style:{position:"relative"},children:[o.jsx("div",{style:{position:"absolute",left:15,top:8,bottom:8,width:2,background:"var(--bd)"}}),A.map((O,B)=>o.jsxs("div",{"data-testid":`changelog-entry-${O.version}`,style:{position:"relative",paddingLeft:44,paddingBottom:B<A.length-1?32:0},children:[o.jsx("div",{style:{position:"absolute",left:8,top:6,width:16,height:16,borderRadius:"50%",background:O.version==="Unreleased"?"var(--txM)":"var(--ac)",border:"3px solid var(--bg, #1a1a1a)"}}),o.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:12,marginBottom:12},children:[o.jsx("span",{style:{fontSize:18,fontWeight:700,color:"var(--tx)",fontFamily:"var(--font-heading, inherit)"},children:O.url?o.jsx("a",{href:O.url,target:"_blank",rel:"noopener noreferrer",style:{color:"inherit",textDecoration:"none"},children:O.version}):O.version}),O.date&&o.jsx("span",{style:{fontSize:13,color:"var(--txM)",fontFamily:"var(--font-code, monospace)"},children:O.date})]}),O.sections.map(H=>o.jsxs("div",{style:{marginBottom:16},children:[o.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:6,marginBottom:8},children:[o.jsx("span",{style:{display:"inline-block",width:8,height:8,borderRadius:"50%",background:eg(H.type)}}),o.jsx("span",{style:{fontSize:12,fontWeight:600,textTransform:"uppercase",letterSpacing:".06em",color:eg(H.type),fontFamily:"var(--font-code, monospace)"},children:H.type})]}),o.jsx("ul",{style:{margin:0,paddingLeft:18,listStyleType:"disc",color:"var(--tx2)"},children:H.items.map((R,x)=>o.jsx("li",{style:{fontSize:14,lineHeight:1.7,color:"var(--tx2)",marginBottom:2},children:R},x))})]},H.type))]},O.version)),!h&&r.length>(E||0)&&o.jsx("div",{style:{textAlign:"center",marginTop:24},children:o.jsxs("button",{"data-testid":"changelog-show-more",onClick:()=>s(!0),style:{background:"none",border:"1px solid var(--bd)",borderRadius:2,padding:"8px 20px",color:"var(--tx2)",fontSize:13,fontFamily:"var(--font-body, inherit)",cursor:"pointer",transition:"border-color .15s, color .15s"},children:["Show all ",r.length," releases"]})})]})}const lg={info:{color:"#3b82f6",label:"INFO"},warning:{color:"#f59e0b",label:"WARNING"},tip:{color:"var(--ac, #a78bfa)",label:"TIP"},danger:{color:"#ef4444",label:"DANGER"}};function x1({type:r="info",title:E,children:h}){const s=lg[r]||lg.info;return o.jsxs("div",{style:{borderLeft:`3px solid ${s.color}`,background:`${s.color}11`,borderRadius:"0 2px 2px 0",padding:"14px 18px",marginBottom:20},children:[E?o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:4},children:[o.jsx("span",{style:{fontWeight:700,fontSize:10,letterSpacing:".08em",color:s.color,fontFamily:"var(--font-code, monospace)"},children:s.label}),o.jsx("span",{style:{fontWeight:600,fontSize:13,color:s.color},children:E})]}):o.jsx("div",{style:{marginBottom:4},children:o.jsx("span",{style:{fontWeight:700,fontSize:10,letterSpacing:".08em",color:s.color,fontFamily:"var(--font-code, monospace)"},children:s.label})}),o.jsx("div",{style:{fontSize:14,lineHeight:1.65,color:"var(--tx2)"},children:h})]})}function S1({items:r,children:E}){const[h,s]=G.useState(0);return o.jsxs("div",{style:{marginBottom:20},children:[o.jsx("div",{style:{display:"flex",gap:0,borderBottom:"1px solid var(--bd)"},children:r.map((A,O)=>o.jsx("button",{onClick:()=>s(O),style:{padding:"8px 16px",background:"none",border:"none",borderBottom:h===O?"2px solid var(--ac)":"2px solid transparent",color:h===O?"var(--ac)":"var(--txM)",fontWeight:h===O?600:400,fontSize:13,cursor:"pointer",fontFamily:"inherit"},children:A},O))}),o.jsx("div",{style:{padding:"16px 0"},children:E[h]})]})}function A1({title:r,icon:E,href:h,children:s}){const A=o.jsxs("div",{style:{border:"1px solid var(--bd)",borderRadius:2,padding:"20px",transition:"border-color 0.15s",cursor:h?"pointer":"default"},children:[E&&o.jsx("span",{style:{fontSize:24,marginBottom:8,display:"block"},children:E}),o.jsx("div",{style:{fontWeight:600,fontSize:14,marginBottom:4},children:r}),s&&o.jsx("div",{style:{fontSize:13,color:"var(--txM)",lineHeight:1.5},children:s})]});return h?o.jsx("a",{href:h,style:{textDecoration:"none",color:"inherit"},children:A}):A}function j1({cols:r=2,children:E}){return o.jsx("div",{style:{display:"grid",gridTemplateColumns:`repeat(${r}, 1fr)`,gap:12,marginBottom:20},children:E})}function E1({children:r}){return o.jsx("div",{style:{paddingLeft:24,borderLeft:"2px solid var(--bd)",marginBottom:20},children:ig.Children.map(r,(E,h)=>o.jsxs("div",{style:{position:"relative",paddingBottom:20},children:[o.jsx("div",{style:{position:"absolute",left:-33,top:0,width:20,height:20,borderRadius:"50%",background:"var(--ac)",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700},children:h+1}),o.jsx("div",{style:{paddingLeft:8},children:E})]}))})}function z1({title:r,children:E}){const[h,s]=G.useState(!1);return o.jsxs("div",{style:{border:"1px solid var(--bd)",borderRadius:2,marginBottom:8,overflow:"hidden"},children:[o.jsxs("button",{onClick:()=>s(!h),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",padding:"12px 16px",background:"var(--sf)",border:"none",cursor:"pointer",fontWeight:500,fontSize:14,color:"var(--tx)",fontFamily:"inherit"},children:[r,o.jsx("span",{style:{transform:h?"rotate(180deg)":"rotate(0)",transition:"transform 0.2s"},children:"▾"})]}),h&&o.jsx("div",{style:{padding:"12px 16px",borderTop:"1px solid var(--bd)",fontSize:14,color:"var(--tx2)",lineHeight:1.65},children:E})]})}const T1={install:{npm:"npm install",yarn:"yarn add",pnpm:"pnpm add",bun:"bun add"},"install -D":{npm:"npm install -D",yarn:"yarn add -D",pnpm:"pnpm add -D",bun:"bun add -d"},uninstall:{npm:"npm uninstall",yarn:"yarn remove",pnpm:"pnpm remove",bun:"bun remove"},run:{npm:"npm run",yarn:"yarn",pnpm:"pnpm",bun:"bun run"},exec:{npm:"npx",yarn:"yarn dlx",pnpm:"pnpm dlx",bun:"bunx"},init:{npm:"npm init",yarn:"yarn init",pnpm:"pnpm init",bun:"bun init"},create:{npm:"npm create",yarn:"yarn create",pnpm:"pnpm create",bun:"bun create"}};function _1(r,E){for(const[h,s]of Object.entries(T1))if(r.startsWith(h+" ")||r===h){const A=r.slice(h.length);return(s[E]||h)+A}return`${E} ${r}`}function M1({command:r}){const[E,h]=G.useState(0),[s,A]=G.useState(!1),O=["npm","yarn","pnpm","bun"],B=_1(r,O[E]);return o.jsxs("div",{style:{border:"1px solid var(--bd)",borderRadius:2,marginBottom:16,overflow:"hidden"},children:[o.jsx("div",{style:{display:"flex",borderBottom:"1px solid var(--bd)",background:"var(--sf)",overflowX:"auto"},children:O.map((H,R)=>o.jsx("button",{onClick:()=>{h(R),A(!1)},style:{padding:"8px 14px",background:"none",border:"none",cursor:"pointer",fontSize:12,fontFamily:"var(--font-code)",fontWeight:R===E?600:400,color:R===E?"var(--ac)":"var(--txM)",borderBottom:R===E?"2px solid var(--ac)":"2px solid transparent",whiteSpace:"nowrap"},children:H},H))}),o.jsxs("div",{style:{display:"flex",alignItems:"center",padding:"10px 14px",background:"var(--cdBg)",gap:8},children:[o.jsx("code",{style:{flex:1,fontFamily:"var(--font-code)",fontSize:13,color:"var(--cdTx)",whiteSpace:"pre",overflowX:"auto"},children:B}),o.jsx("button",{onClick:()=>{var H;(H=navigator.clipboard)==null||H.writeText(B),A(!0),setTimeout(()=>A(!1),2e3)},style:{background:"none",border:"none",cursor:"pointer",color:"var(--txM)",fontSize:12,fontFamily:"var(--font-code)",flexShrink:0},children:s?"✓":"Copy"})]})]})}function O1({name:r,fields:E}){return o.jsxs("div",{style:{marginBottom:16},children:[r&&o.jsx("h4",{style:{fontFamily:"var(--font-code)",fontSize:15,marginBottom:8,color:"var(--tx)"},children:r}),o.jsx("div",{style:{overflowX:"auto",WebkitOverflowScrolling:"touch"},children:o.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:13,fontFamily:"var(--font-body)"},children:[o.jsx("thead",{children:o.jsx("tr",{style:{borderBottom:"2px solid var(--bd)"},children:["Property","Type","Required","Default","Description"].map(h=>o.jsx("th",{style:{textAlign:"left",padding:"8px 10px",color:"var(--txM)",fontWeight:600,fontSize:11,textTransform:"uppercase",letterSpacing:".05em",whiteSpace:"nowrap"},children:h},h))})}),o.jsx("tbody",{children:E.map(h=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--bd)"},children:[o.jsx("td",{style:{padding:"8px 10px",fontFamily:"var(--font-code)",fontWeight:500,color:"var(--tx)"},children:h.name}),o.jsx("td",{style:{padding:"8px 10px",fontFamily:"var(--font-code)",fontSize:12,color:"var(--ac)"},children:h.type}),o.jsx("td",{style:{padding:"8px 10px"},children:h.required&&o.jsx("span",{style:{fontSize:10,fontWeight:600,color:"#e04040",background:"rgba(224,64,64,0.1)",padding:"2px 6px",borderRadius:2},children:"required"})}),o.jsx("td",{style:{padding:"8px 10px",fontFamily:"var(--font-code)",fontSize:12,color:"var(--txM)"},children:h.default||"—"}),o.jsx("td",{style:{padding:"8px 10px",color:"var(--tx2)"},children:h.description||""})]},h.name))})]})})]})}function D1({name:r}){return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,padding:"3px 0",fontFamily:"var(--font-code)",fontSize:13,color:"var(--tx2)"},children:[o.jsx("span",{style:{opacity:.6},children:"📄"})," ",r]})}function R1({name:r,defaultOpen:E,children:h}){const[s,A]=G.useState(E??!1);return o.jsxs("div",{children:[o.jsxs("button",{onClick:()=>A(!s),style:{display:"flex",alignItems:"center",gap:6,padding:"3px 0",background:"none",border:"none",cursor:"pointer",fontFamily:"var(--font-code)",fontSize:13,color:"var(--tx)",fontWeight:500},children:[o.jsx("span",{children:s?"📂":"📁"})," ",r]}),s&&o.jsx("div",{style:{paddingLeft:18,borderLeft:"1px solid var(--bd)",marginLeft:8},children:h})]})}function Wo({children:r}){return o.jsx("div",{style:{border:"1px solid var(--bd)",borderRadius:2,padding:"12px 16px",background:"var(--cdBg)",marginBottom:16},children:r})}Wo.File=D1;Wo.Folder=R1;const C1={Callout:x1,Tabs:S1,Card:A1,CardGroup:j1,Steps:E1,Accordion:z1,ChangelogTimeline:y1,PackageManager:M1,TypeTable:O1,FileTree:Wo,CodeSamples:h1,LinkCard:p1,CardGrid:v1},B1=`
...
`,zu=(ui.basePath||"/").replace(/\/$/,"");function U1(r){return og(r,zu,Ve)}function Ko(r){return c1(r,zu,Ve)}const rg=s1(window.location.pathname,window.location.hash,Ve,zu,og),H1=sg(rg,Ve,fg);function G1(){var cn;const[r,E]=G.useState(rg),[h,s]=G.useState(null),[A,O]=G.useState(!0),B=G.useCallback(async(D,Y)=>{O(!0),E(D);const Z=Ko(D);Y!=null&&Y.replace?window.history.replaceState(null,"",Z):window.history.pushState(null,"",Z);const L=await sg(D,Ve,fg);if(s(L),O(!1),!(Y!=null&&Y.skipScroll)){const pn=window.location.hash.slice(1);pn?requestAnimationFrame(()=>{const jn=document.getElementById(pn);jn&&jn.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);G.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&Ve.some(Y=>Y.id===D)){const Y=Ko(D);window.history.replaceState(null,"",Y),B(D,{replace:!0})}else{const Y=Ko(r);window.history.replaceState(null,"",Y),H1.then(Z=>{s(Z),O(!1)})}},[]),G.useEffect(()=>{const D=()=>{const Y=U1(window.location.pathname);Y&&Y!==r&&B(Y,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[r,B]);const H=G.useRef(null),[R,x]=G.useState(()=>{var Y,Z;if(typeof document>"u")return"light";if(document.documentElement.classList.contains("dark"))return"dark";const D=((Y=ui.theme)==null?void 0:Y.mode)||"auto";return D==="dark"?"dark":D==="light"?"light":(Z=window.matchMedia)!=null&&Z.call(window,"(prefers-color-scheme: dark)").matches?"dark":"light"});G.useEffect(()=>{const D=new MutationObserver(()=>{const Y=document.documentElement.classList.contains("dark");x(Y?"dark":"light")});return D.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>D.disconnect()},[]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{H.current||(H.current=(await import(Z)).default);const L=H.current;if(Y)return;const pn=R==="dark",jn=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";L.initialize({startOnLoad:!1,theme:pn?"dark":"default",fontFamily:jn,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let w=0;w<D.length;w++){const Cn=D[w],Wn=Cn.getAttribute("data-mermaid");if(Wn)try{const _n=atob(Wn),{svg:In}=await L.render(`tome-mermaid-${w}-${Date.now()}`,_n);Y||(Cn.innerHTML=In)}catch(_n){console.warn("[tome] Mermaid render failed:",_n),Cn.textContent="Diagram rendering failed",Cn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(L){console.warn("[tome] Failed to load mermaid from CDN:",L),D.forEach(pn=>{pn.textContent="Failed to load diagram renderer",pn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{Y=!0}},[h,A,R]),G.useEffect(()=>{if(A)return;const D=document.querySelectorAll(".tome-content pre"),Y=[];return D.forEach(Z=>{if(Z.querySelector(".tome-copy-btn"))return;const L=document.createElement("button");L.className="tome-copy-btn",L.textContent="Copy",L.addEventListener("click",async()=>{const pn=Z.querySelector("code");if(pn)try{await navigator.clipboard.writeText(pn.textContent||""),L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},2e3)}catch{L.textContent="Failed",setTimeout(()=>{L.textContent="Copy"},2e3)}}),Z.appendChild(L),Y.push(L)}),()=>{Y.forEach(Z=>Z.remove())}},[h,A]);const V=Ve.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),C=Ve.find(D=>D.id===r),F=f1(C),J=o1(ui.editLink,C==null?void 0:C.filePath),yn=(C==null?void 0:C.locale)||(Zo==null?void 0:Zo.defaultLocale)||"en",tn="ltr";return G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]").length>0;if(!ui.math&&!D)return;const Y="tome-katex-css";if(document.getElementById(Y))return;const Z=document.createElement("link");Z.id=Y,Z.rel="stylesheet",Z.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",Z.crossOrigin="anonymous",document.head.appendChild(Z)},[h,A]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const L=(await import(Z)).default;if(Y)return;for(const pn of D){const jn=pn.getAttribute("data-math");if(jn)try{const w=atob(jn),Cn=pn.classList.contains("tome-math-block");L.render(w,pn,{displayMode:Cn,throwOnError:!1})}catch(w){console.warn("[tome] KaTeX render failed:",w)}}}catch(L){console.warn("[tome] Failed to load KaTeX from CDN:",L)}})(),()=>{Y=!0}},[h,A]),o.jsxs(o.Fragment,{children:[o.jsx("style",{children:B1}),o.jsx(i1,{config:ui,navigation:r1,currentPageId:r,pageHtml:h!=null&&h.isMdx?void 0:A?"":(h==null?void 0:h.html)||"<p>Page not found</p>",pageComponent:h!=null&&h.isMdx?h.component:void 0,mdxComponents:C1,pageTitle:(h==null?void 0:h.frontmatter.title)||(A?"":"Not Found"),pageDescription:h==null?void 0:h.frontmatter.description,headings:(h==null?void 0:h.headings)||[],tocEnabled:(h==null?void 0:h.frontmatter.toc)!==!1,editUrl:J,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:h!=null&&h.isMdx||h==null?void 0:h.changelogEntries,onNavigate:B,allPages:V,docContext:g1,versioning:void 0,currentVersion:F,basePath:zu,isDraft:((cn=C==null?void 0:C.frontmatter)==null?void 0:cn.draft)===!0,dir:tn,i18n:void 0,currentLocale:yn,overrides:m1})]})}const ag=document.getElementById("tome-root");ag&&Rm.createRoot(ag).render(o.jsx(G1,{}));
