const n={frontmatter:{title:"创建知识库",description:"创建一个知识库，把笔记、文件、直播、博主内容集中管理，支持 AI 搜索和问答",hidden:!1,toc:!0,draft:!1},html:`<h1 id="创建知识库"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#创建知识库"><span class="icon icon-link"></span></a>创建知识库</h1>
<p>把相关的内容放在一起，方便查找和管理。比如创建一个「读书笔记」知识库，把所有读书相关的笔记都放进去，以后想找什么直接搜。</p>
<h2 id="是什么"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#是什么"><span class="icon icon-link"></span></a>是什么</h2>
<p>知识库就像一个智能文件夹。你可以把笔记、PDF、直播记录、博主视频都丢进去，然后用 AI 搜索、提问，快速找到你要的信息。</p>
<p>普通文件夹只能按名字找，知识库能理解内容——你可以问「上次开会说的那个方案是什么」，AI 会帮你翻出来。</p>
<h2 id="怎么创建"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#怎么创建"><span class="icon icon-link"></span></a>怎么创建</h2>
...
<p><img src="/getbiji-docs-v3/images/ZNMSbuHSqotgUMx3BVCcu74mnBf.jpg" alt="App 首页顶部导航栏，左侧显示「更多」入口按钮，点击可进入知识库等功能页面"></p>
...
<blockquote>
<p>删除知识库会同时删除里面的文件内容，请谨慎操作。知识库中的笔记不会被删除，因为笔记只是「加入」了知识库，原始笔记仍保留在首页。</p>
</blockquote>
<h2 id="下一步"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#下一步"><span class="icon icon-link"></span></a>下一步</h2>
<p>创建好知识库后，可以往里面添加内容：</p>
<ul>
<li><a href="/knowledge-base/upload">上传文件</a> — PDF、Word、PPT 一键上传</li>
<li><a href="/knowledge-base/subscribe-live">订阅直播</a> — AI 帮你听直播，自动生成笔记</li>
<li><a href="/knowledge-base/subscribe-creator">订阅博主</a> — 博主发新视频，自动变笔记</li>
<li><a href="/knowledge-base/add-notes">添加已有笔记</a> — 把之前记的笔记加进来</li>
</ul>`,headings:[{depth:2,text:"是什么",id:"是什么"},{depth:2,text:"怎么创建",id:"怎么创建"},{depth:3,text:"App 端",id:"app-端"},{depth:3,text:"网页端",id:"网页端"},{depth:2,text:"容量限制",id:"容量限制"},{depth:2,text:"下一步",id:"下一步"}],raw:`
# 创建知识库
