const n={frontmatter:{title:"智能拍书",description:"拍下纸质书页自动识别书籍，3 秒变成数字笔记并归类到对应书籍",hidden:!1,toc:!0,draft:!1},html:`<h1 id="智能拍书"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#智能拍书"><span class="icon icon-link"></span></a>智能拍书</h1>
<p>拍下纸质书页，3 秒变成数字笔记，还会自动归类到对应书籍下。看到好段落、好句子，拍下来就能保存，纸质书的阅读痕迹再也不会丢失。</p>
<h2 id="什么时候用"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#什么时候用"><span class="icon icon-link"></span></a>什么时候用</h2>
<ul>
<li>读书划线：把书中划线、批注快速数字化保存</li>
<li>金句摘录：重要段落、观点一拍即存</li>
<li>学术研究：论文、专业书籍内容提取和整理</li>
<li>写作素材：积累读书笔记，用 AI 随时查找书中观点</li>
</ul>
...
<p><img src="/images/FvHHbp50koL0YdxetNscbB76ngh.png" alt="「更多方式」底部弹出面板，列出粘贴链接、拍照、上传图片、线下会议录音、智能拍书、导入音视频、手机内录等选项，「智能拍书」带有 NEW 标签并用红框高亮标注，描述为「对准书页拍一下，自动提取归类到书籍」"></p>
...
<p><img src="/images/UsFtbm0HPoH8dTxaSL0cOHwrntf.png" alt="手机相机拍摄界面，对准一本纸质书的书页内容进行拍照，页面底部显示「重拍」和「使用照片」两个操作按钮"></p>
...
<p><img src="/images/TR5YbUwnWomziXxLwBYctoKLngg.png" alt="拍书预览页面，上方展示 AI 增强后的清晰书页文字，中间显示页码翻页控件和「继续拍」按钮，下方「添加到书籍」区域展示「自动识别书籍」（已勾选）以及最近阅读的书籍封面缩略图，底部提供「原图」和「增强」切换及「下一步」按钮"></p>
<p><img src="/images/Qdp9bfNp4om9j2xwM1qcnNNSnNb.png" alt="AI 自动识别书籍确认页面，上方显示增强后的书页文字内容，下方展示识别结果为《预测之书》（罗振宇编著，新星出版社），配有书籍封面图，底部提供「更换」和「确认」两个按钮"></p>
...
<p><img src="/images/CijpbVuHToBANlxqoKZc5h7Snpe.png" alt="《预测之书》的读书笔记详情页，顶部显示书籍封面、书名、作者和出版社信息，下方显示「1 条笔记」，笔记卡片内展示 AI 提取的书页文字内容摘要和原始书页缩略图"></p>
<p>笔记会自动归类到对应书籍下，可以继续拍照或查看整理结果。</p>
<p><img src="/images/Qsgzbb0F2oi4v1xJ607cwBu0nmf.png" alt="AI 助手对话界面，显示「你好，我是你的 AI 助手」欢迎语，提供「合并生成笔记」「按时间轴整理内容」「输出一份 PPT 大纲」「生成问答卡片」等快捷操作，底部已选中《预测之书》（1 条笔记）作为对话的知识范围，旁边有「继续添加」按钮"></p>
...
<p><img src="/images/MwDwb123lobmX7xv7M0cnUfEnLd.png" alt="侧边栏个人中心页面，显示用户头像和 PRO 会员标识，统计数据（全部笔记、累计天数、连续天数），笔记热力图，以及日历、Get 日报、知识库、书籍等功能入口，「书籍」选项显示 186 本并用红框高亮标注"></p>
<p><img src="/images/TNa9b48yFoClTAxVPcXcn8g0nCc.png" alt="书籍列表页面，顶部显示「共 3713 条笔记 · 来自 186 本书」，以书籍封面网格形式展示所有书籍，包括《预测之书》《财经》《思考，快与慢》《你当像鸟飞往你的山》《北海怪兽》等，每本书下方标注笔记数量"></p>
...
<li><strong>AI 搜索</strong>：支持通过搜索或 AI 对话快速定位笔记内容</li>
<li><strong>查看原文</strong>：可以跳转到对应书籍的章节段落查看原文</li>
</ul>
<blockquote>
<p>拍书整理仅限个人学习使用，请尊重版权。</p>
</blockquote>`,headings:[{depth:2,text:"什么时候用",id:"什么时候用"},{depth:2,text:"怎么用",id:"怎么用"},{depth:3,text:"第一步：点「+」，选「智能拍书」",id:"第一步点选智能拍书"},{depth:3,text:"第二步：对着书页拍照",id:"第二步对着书页拍照"},{depth:3,text:"第三步：确认书籍信息",id:"第三步确认书籍信息"},{depth:3,text:"第四步：AI 处理并生成笔记",id:"第四步ai-处理并生成笔记"},{depth:3,text:"查看所有读书笔记",id:"查看所有读书笔记"},{depth:2,text:"小技巧",id:"小技巧"}],raw:`
# 智能拍书
