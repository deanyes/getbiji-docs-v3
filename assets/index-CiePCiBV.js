...
`,Tu=(ui.basePath||"/").replace(/\/$/,"");function U1(r){return og(r,Tu,Vn)}function Ko(r){return c1(r,Tu,Vn)}const rg=s1(window.location.pathname,window.location.hash,Vn,Tu,og),G1=sg(rg,Vn,fg);function H1(){var ut;const[r,E]=H.useState(rg),[p,s]=H.useState(null),[A,O]=H.useState(!0),B=H.useCallback(async(D,Y)=>{O(!0),E(D);const Z=Ko(D);Y!=null&&Y.replace?window.history.replaceState(null,"",Z):window.history.pushState(null,"",Z);const L=await sg(D,Vn,fg);if(s(L),O(!1),!(Y!=null&&Y.skipScroll)){const pt=window.location.hash.slice(1);pt?requestAnimationFrame(()=>{const At=document.getElementById(pt);At&&At.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);H.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&Vn.some(Y=>Y.id===D)){const Y=Ko(D);window.history.replaceState(null,"",Y),B(D,{replace:!0})}else{const Y=Ko(r);window.history.replaceState(null,"",Y),G1.then(Z=>{s(Z),O(!1)})}},[]),H.useEffect(()=>{const D=()=>{const Y=U1(window.location.pathname);Y&&Y!==r&&B(Y,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[r,B]);const G=H.useRef(null),[R,x]=H.useState(()=>{var Y,Z;if(typeof document>"u")return"light";if(document.documentElement.classList.contains("dark"))return"dark";const D=((Y=ui.theme)==null?void 0:Y.mode)||"auto";return D==="dark"?"dark":D==="light"?"light":(Z=window.matchMedia)!=null&&Z.call(window,"(prefers-color-scheme: dark)").matches?"dark":"light"});H.useEffect(()=>{const D=new MutationObserver(()=>{const Y=document.documentElement.classList.contains("dark");x(Y?"dark":"light")});return D.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>D.disconnect()},[]),H.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{G.current||(G.current=(await import(Z)).default);const L=G.current;if(Y)return;const pt=R==="dark",At=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";L.initialize({startOnLoad:!1,theme:pt?"dark":"default",fontFamily:At,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let w=0;w<D.length;w++){const Rt=D[w],Jt=Rt.getAttribute("data-mermaid");if(Jt)try{const zt=atob(Jt),{svg:Wt}=await L.render(`tome-mermaid-${w}-${Date.now()}`,zt);Y||(Rt.innerHTML=Wt)}catch(zt){console.warn("[tome] Mermaid render failed:",zt),Rt.textContent="Diagram rendering failed",Rt.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(L){console.warn("[tome] Failed to load mermaid from CDN:",L),D.forEach(pt=>{pt.textContent="Failed to load diagram renderer",pt.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{Y=!0}},[p,A,R]),H.useEffect(()=>{if(A)return;const D=document.querySelectorAll(".tome-content pre"),Y=[];return D.forEach(Z=>{if(Z.querySelector(".tome-copy-btn"))return;const L=document.createElement("button");L.className="tome-copy-btn",L.textContent="Copy",L.addEventListener("click",async()=>{const pt=Z.querySelector("code");if(pt)try{await navigator.clipboard.writeText(pt.textContent||""),L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},2e3)}catch{L.textContent="Failed",setTimeout(()=>{L.textContent="Copy"},2e3)}}),Z.appendChild(L),Y.push(L)}),()=>{Y.forEach(Z=>Z.remove())}},[p,A]);const V=Vn.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),C=Vn.find(D=>D.id===r),F=f1(C),J=o1(ui.editLink,C==null?void 0:C.filePath),bt=(C==null?void 0:C.locale)||(Zo==null?void 0:Zo.defaultLocale)||"en",et="ltr";return H.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]").length>0;if(!ui.math&&!D)return;const Y="tome-katex-css";if(document.getElementById(Y))return;const Z=document.createElement("link");Z.id=Y,Z.rel="stylesheet",Z.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",Z.crossOrigin="anonymous",document.head.appendChild(Z)},[p,A]),H.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const L=(await import(Z)).default;if(Y)return;for(const pt of D){const At=pt.getAttribute("data-math");if(At)try{const w=atob(At),Rt=pt.classList.contains("tome-math-block");L.render(w,pt,{displayMode:Rt,throwOnError:!1})}catch(w){console.warn("[tome] KaTeX render failed:",w)}}}catch(L){console.warn("[tome] Failed to load KaTeX from CDN:",L)}})(),()=>{Y=!0}},[p,A]),o.jsxs(o.Fragment,{children:[o.jsx("style",{children:B1}),o.jsx(i1,{config:ui,navigation:r1,currentPageId:r,pageHtml:p!=null&&p.isMdx?void 0:A?"":(p==null?void 0:p.html)||"<p>Page not found</p>",pageComponent:p!=null&&p.isMdx?p.component:void 0,mdxComponents:C1,pageTitle:(p==null?void 0:p.frontmatter.title)||(A?"":"Not Found"),pageDescription:p==null?void 0:p.frontmatter.description,headings:(p==null?void 0:p.headings)||[],tocEnabled:(p==null?void 0:p.frontmatter.toc)!==!1,editUrl:J,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:p!=null&&p.isMdx||p==null?void 0:p.changelogEntries,onNavigate:B,allPages:V,docContext:g1,versioning:void 0,currentVersion:F,basePath:Tu,isDraft:((ut=C==null?void 0:C.frontmatter)==null?void 0:ut.draft)===!0,dir:et,i18n:void 0,currentLocale:bt,overrides:m1})]})}const ag=document.getElementById("tome-root");ag&&Rm.createRoot(ag).render(o.jsx(H1,{}));
