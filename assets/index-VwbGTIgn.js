(function(){const E=document.createElement("link").relList;if(E&&E.supports&&E.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))f(A);new MutationObserver(A=>{for(const O of A)if(O.type==="childList")for(const B of O.addedNodes)B.tagName==="LINK"&&B.rel==="modulepreload"&&f(B)}).observe(document,{childList:!0,subtree:!0});function p(A){const O={};return A.integrity&&(O.integrity=A.integrity),A.referrerPolicy&&(O.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?O.credentials="include":A.crossOrigin==="anonymous"?O.credentials="omit":O.credentials="same-origin",O}function f(A){if(A.ep)return;A.ep=!0;const O=p(A);fetch(A.href,O)}})();function Sm(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var qo={exports:{}},ai={};/**
 * @license React
 ...
 */var Ld;function Am(){if(Ld)return ai;Ld=1;var r=Symbol.for("react.transitional.element"),E=Symbol.for("react.fragment");function p(f,A,O){var B=null;if(O!==void 0&&(B=""+O),A.key!==void 0&&(B=""+A.key),"key"in A){O={};for(var H in A)H!=="key"&&(O[H]=A[H])}else O=A;return A=O.ref,{$$typeof:r,type:f,key:B,ref:A!==void 0?A:null,props:O}}return ai.Fragment=E,ai.jsx=p,ai.jsxs=p,ai}var Yd;function jm(){return Yd||(Yd=1,qo.exports=Am()),qo.exports}var o=jm(),Lo={exports:{}},nn={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kd;function Em(){if(kd)return nn;kd=1;var r=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),p=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),O=Symbol.for("react.consumer"),B=Symbol.for("react.context"),H=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),F=Symbol.iterator;function J(g){return g===null||typeof g!="object"?null:(g=F&&g[F]||g["@@iterator"],typeof g=="function"?g:null)}var yn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},tn=Object.assign,cn={};function D(g,_,N){this.props=g,this.context=_,this.refs=cn,this.updater=N||yn}D.prototype.isReactComponent={},D.prototype.setState=function(g,_){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,_,"setState")},D.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Y(){}Y.prototype=D.prototype;function Z(g,_,N){this.props=g,this.context=_,this.refs=cn,this.updater=N||yn}var L=Z.prototype=new Y;L.constructor=Z,tn(L,D.prototype),L.isPureReactComponent=!0;var hn=Array.isArray;function jn(){}var w={H:null,A:null,T:null,S:null},Cn=Object.prototype.hasOwnProperty;function Wn(g,_,N){var k=N.ref;return{$$typeof:r,type:g,key:_,ref:k!==void 0?k:null,props:N}}function Mn(g,_){return Wn(g.type,_,g.props)}function In(g){return typeof g=="object"&&g!==null&&g.$$typeof===r}function Hn(g){var _={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(N){return _[N]})}var Ot=/\/+/g;function on(g,_){return typeof g=="object"&&g!==null&&g.key!=null?Hn(""+g.key):_.toString(36)}function yt(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(jn,jn):(g.status="pending",g.then(function(_){g.status==="pending"&&(g.status="fulfilled",g.value=_)},function(_){g.status==="pending"&&(g.status="rejected",g.reason=_)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function j(g,_,N,k,$){var an=typeof g;(an==="undefined"||an==="boolean")&&(g=null);var vn=!1;if(g===null)vn=!0;else switch(an){case"bigint":case"string":case"number":vn=!0;break;case"object":switch(g.$$typeof){case r:case E:vn=!0;break;case V:return vn=g._init,j(vn(g._payload),_,N,k,$)}}if(vn)return $=$(g),vn=k===""?"."+on(g,0):k,hn($)?(N="",vn!=null&&(N=vn.replace(Ot,"$&/")+"/"),j($,_,N,"",function(Ze){return Ze})):$!=null&&(In($)&&($=Mn($,N+($.key==null||g&&g.key===$.key?"":(""+$.key).replace(Ot,"$&/")+"/")+vn)),_.push($)),1;vn=0;var Pn=k===""?".":k+":";if(hn(g))for(var wn=0;wn<g.length;wn++)k=g[wn],an=Pn+on(k,wn),vn+=j(k,_,N,an,$);else if(wn=J(g),typeof wn=="function")for(g=wn.call(g),wn=0;!(k=g.next()).done;)k=k.value,an=Pn+on(k,wn++),vn+=j(k,_,N,an,$);else if(an==="object"){if(typeof g.then=="function")return j(yt(g),_,N,k,$);throw _=String(g),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return vn}function U(g,_,N){if(g==null)return g;var k=[],$=0;return j(g,k,"","",function(an){return _.call(N,an,$++)}),k}function W(g){if(g._status===-1){var _=g._result;_=_(),_.then(function(N){(g._status===0||g._status===-1)&&(g._status=1,g._result=N)},function(N){(g._status===0||g._status===-1)&&(g._status=2,g._result=N)}),g._status===-1&&(g._status=0,g._result=_)}if(g._status===1)return g._result.default;throw g._result}var fn=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},En={map:U,forEach:function(g,_,N){U(g,function(){_.apply(this,arguments)},N)},count:function(g){var _=0;return U(g,function(){_++}),_},toArray:function(g){return U(g,function(_){return _})||[]},only:function(g){if(!In(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return nn.Activity=C,nn.Children=En,nn.Component=D,nn.Fragment=p,nn.Profiler=A,nn.PureComponent=Z,nn.StrictMode=f,nn.Suspense=R,nn.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=w,nn.__COMPILER_RUNTIME={__proto__:null,c:function(g){return w.H.useMemoCache(g)}},nn.cache=function(g){return function(){return g.apply(null,arguments)}},nn.cacheSignal=function(){return null},nn.cloneElement=function(g,_,N){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var k=tn({},g.props),$=g.key;if(_!=null)for(an in _.key!==void 0&&($=""+_.key),_)!Cn.call(_,an)||an==="key"||an==="__self"||an==="__source"||an==="ref"&&_.ref===void 0||(k[an]=_[an]);var an=arguments.length-2;if(an===1)k.children=N;else if(1<an){for(var vn=Array(an),Pn=0;Pn<an;Pn++)vn[Pn]=arguments[Pn+2];k.children=vn}return Wn(g.type,$,k)},nn.createContext=function(g){return g={$$typeof:B,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:O,_context:g},g},nn.createElement=function(g,_,N){var k,$={},an=null;if(_!=null)for(k in _.key!==void 0&&(an=""+_.key),_)Cn.call(_,k)&&k!=="key"&&k!=="__self"&&k!=="__source"&&($[k]=_[k]);var vn=arguments.length-2;if(vn===1)$.children=N;else if(1<vn){for(var Pn=Array(vn),wn=0;wn<vn;wn++)Pn[wn]=arguments[wn+2];$.children=Pn}if(g&&g.defaultProps)for(k in vn=g.defaultProps,vn)$[k]===void 0&&($[k]=vn[k]);return Wn(g,an,$)},nn.createRef=function(){return{current:null}},nn.forwardRef=function(g){return{$$typeof:H,render:g}},nn.isValidElement=In,nn.lazy=function(g){return{$$typeof:V,_payload:{_status:-1,_result:g},_init:W}},nn.memo=function(g,_){return{$$typeof:x,type:g,compare:_===void 0?null:_}},nn.startTransition=function(g){var _=w.T,N={};w.T=N;try{var k=g(),$=w.S;$!==null&&$(N,k),typeof k=="object"&&k!==null&&typeof k.then=="function"&&k.then(jn,fn)}catch(an){fn(an)}finally{_!==null&&N.types!==null&&(_.types=N.types),w.T=_}},nn.unstable_useCacheRefresh=function(){return w.H.useCacheRefresh()},nn.use=function(g){return w.H.use(g)},nn.useActionState=function(g,_,N){return w.H.useActionState(g,_,N)},nn.useCallback=function(g,_){return w.H.useCallback(g,_)},nn.useContext=function(g){return w.H.useContext(g)},nn.useDebugValue=function(){},nn.useDeferredValue=function(g,_){return w.H.useDeferredValue(g,_)},nn.useEffect=function(g,_){return w.H.useEffect(g,_)},nn.useEffectEvent=function(g){return w.H.useEffectEvent(g)},nn.useId=function(){return w.H.useId()},nn.useImperativeHandle=function(g,_,N){return w.H.useImperativeHandle(g,_,N)},nn.useInsertionEffect=function(g,_){return w.H.useInsertionEffect(g,_)},nn.useLayoutEffect=function(g,_){return w.H.useLayoutEffect(g,_)},nn.useMemo=function(g,_){return w.H.useMemo(g,_)},nn.useOptimistic=function(g,_){return w.H.useOptimistic(g,_)},nn.useReducer=function(g,_,N){return w.H.useReducer(g,_,N)},nn.useRef=function(g){return w.H.useRef(g)},nn.useState=function(g){return w.H.useState(g)},nn.useSyncExternalStore=function(g,_,N){return w.H.useSyncExternalStore(g,_,N)},nn.useTransition=function(){return w.H.useTransition()},nn.version="19.2.4",nn}var Qd;function Jo(){return Qd||(Qd=1,Lo.exports=Em()),Lo.exports}var G=Jo();const ig=Sm(G);var Yo={exports:{}},ii={},ko={exports:{}},Qo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xd;function Tm(){return Xd||(Xd=1,(function(r){function E(j,U){var W=j.length;j.push(U);n:for(;0<W;){var fn=W-1>>>1,En=j[fn];if(0<A(En,U))j[fn]=U,j[W]=En,W=fn;else break n}}function p(j){return j.length===0?null:j[0]}function f(j){if(j.length===0)return null;var U=j[0],W=j.pop();if(W!==U){j[0]=W;n:for(var fn=0,En=j.length,g=En>>>1;fn<g;){var _=2*(fn+1)-1,N=j[_],k=_+1,$=j[k];if(0>A(N,W))k<En&&0>A($,N)?(j[fn]=$,j[k]=W,fn=k):(j[fn]=N,j[_]=W,fn=_);else if(k<En&&0>A($,W))j[fn]=$,j[k]=W,fn=k;else break n}}return U}function A(j,U){var W=j.sortIndex-U.sortIndex;return W!==0?W:j.id-U.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;r.unstable_now=function(){return O.now()}}else{var B=Date,H=B.now();r.unstable_now=function(){return B.now()-H}}var R=[],x=[],V=1,C=null,F=3,J=!1,yn=!1,tn=!1,cn=!1,D=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function L(j){for(var U=p(x);U!==null;){if(U.callback===null)f(x);else if(U.startTime<=j)f(x),U.sortIndex=U.expirationTime,E(R,U);else break;U=p(x)}}function hn(j){if(tn=!1,L(j),!yn)if(p(R)!==null)yn=!0,jn||(jn=!0,Hn());else{var U=p(x);U!==null&&yt(hn,U.startTime-j)}}var jn=!1,w=-1,Cn=5,Wn=-1;function Mn(){return cn?!0:!(r.unstable_now()-Wn<Cn)}function In(){if(cn=!1,jn){var j=r.unstable_now();Wn=j;var U=!0;try{n:{yn=!1,tn&&(tn=!1,Y(w),w=-1),J=!0;var W=F;try{t:{for(L(j),C=p(R);C!==null&&!(C.expirationTime>j&&Mn());){var fn=C.callback;if(typeof fn=="function"){C.callback=null,F=C.priorityLevel;var En=fn(C.expirationTime<=j);if(j=r.unstable_now(),typeof En=="function"){C.callback=En,L(j),U=!0;break t}C===p(R)&&f(R),L(j)}else f(R);C=p(R)}if(C!==null)U=!0;else{var g=p(x);g!==null&&yt(hn,g.startTime-j),U=!1}}break n}finally{C=null,F=W,J=!1}U=void 0}}finally{U?Hn():jn=!1}}}var Hn;if(typeof Z=="function")Hn=function(){Z(In)};else if(typeof MessageChannel<"u"){var Ot=new MessageChannel,on=Ot.port2;Ot.port1.onmessage=In,Hn=function(){on.postMessage(null)}}else Hn=function(){D(In,0)};function yt(j,U){w=D(function(){j(r.unstable_now())},U)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Cn=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return F},r.unstable_next=function(j){switch(F){case 1:case 2:case 3:var U=3;break;default:U=F}var W=F;F=U;try{return j()}finally{F=W}},r.unstable_requestPaint=function(){cn=!0},r.unstable_runWithPriority=function(j,U){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var W=F;F=j;try{return U()}finally{F=W}},r.unstable_scheduleCallback=function(j,U,W){var fn=r.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?fn+W:fn):W=fn,j){case 1:var En=-1;break;case 2:En=250;break;case 5:En=1073741823;break;case 4:En=1e4;break;default:En=5e3}return En=W+En,j={id:V++,callback:U,priorityLevel:j,startTime:W,expirationTime:En,sortIndex:-1},W>fn?(j.sortIndex=W,E(x,j),p(R)===null&&j===p(x)&&(tn?(Y(w),w=-1):tn=!0,yt(hn,W-fn))):(j.sortIndex=En,E(R,j),yn||J||(yn=!0,jn||(jn=!0,Hn()))),j},r.unstable_shouldYield=Mn,r.unstable_wrapCallback=function(j){var U=F;return function(){var W=F;F=U;try{return j.apply(this,arguments)}finally{F=W}}}})(Qo)),Qo}var Vd;function zm(){return Vd||(Vd=1,ko.exports=Tm()),ko.exports}var Xo={exports:{}},st={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zd;function Mm(){if(Zd)return st;Zd=1;var r=Jo();function E(R){var x="https://react.dev/errors/"+R;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var V=2;V<arguments.length;V++)x+="&args[]="+encodeURIComponent(arguments[V])}return"Minified React error #"+R+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function p(){}var f={d:{f:p,r:function(){throw Error(E(522))},D:p,C:p,L:p,m:p,X:p,S:p,M:p},p:0,findDOMNode:null},A=Symbol.for("react.portal");function O(R,x,V){var C=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:A,key:C==null?null:""+C,children:R,containerInfo:x,implementation:V}}var B=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function H(R,x){if(R==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return st.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=f,st.createPortal=function(R,x){var V=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(E(299));return O(R,x,null,V)},st.flushSync=function(R){var x=B.T,V=f.p;try{if(B.T=null,f.p=2,R)return R()}finally{B.T=x,f.p=V,f.d.f()}},st.preconnect=function(R,x){typeof R=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,f.d.C(R,x))},st.prefetchDNS=function(R){typeof R=="string"&&f.d.D(R)},st.preinit=function(R,x){if(typeof R=="string"&&x&&typeof x.as=="string"){var V=x.as,C=H(V,x.crossOrigin),F=typeof x.integrity=="string"?x.integrity:void 0,J=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;V==="style"?f.d.S(R,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:C,integrity:F,fetchPriority:J}):V==="script"&&f.d.X(R,{crossOrigin:C,integrity:F,fetchPriority:J,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},st.preinitModule=function(R,x){if(typeof R=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var V=H(x.as,x.crossOrigin);f.d.M(R,{crossOrigin:V,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&f.d.M(R)},st.preload=function(R,x){if(typeof R=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var V=x.as,C=H(V,x.crossOrigin);f.d.L(R,V,{crossOrigin:C,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},st.preloadModule=function(R,x){if(typeof R=="string")if(x){var V=H(x.as,x.crossOrigin);f.d.m(R,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:V,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else f.d.m(R)},st.requestFormReset=function(R){f.d.r(R)},st.unstable_batchedUpdates=function(R,x){return R(x)},st.useFormState=function(R,x,V){return B.H.useFormState(R,x,V)},st.useFormStatus=function(){return B.H.useHostTransitionStatus()},st.version="19.2.4",st}var Kd;function _m(){if(Kd)return Xo.exports;Kd=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(E){console.error(E)}}return r(),Xo.exports=Mm(),Xo.exports}/**
 * @license React
...
| --- | --- |
| iOS | App Store |
| Android | 应用宝、华为、小米、OPPO、VIVO、荣耀 |
| HarmonyOS | 华为应用市场 |
...
`,Tu=(ui.basePath||"/").replace(/\/$/,"");function U1(r){return og(r,Tu,Ve)}function Ko(r){return c1(r,Tu,Ve)}const rg=f1(window.location.pathname,window.location.hash,Ve,Tu,og),H1=fg(rg,Ve,sg);function G1(){var cn;const[r,E]=G.useState(rg),[p,f]=G.useState(null),[A,O]=G.useState(!0),B=G.useCallback(async(D,Y)=>{O(!0),E(D);const Z=Ko(D);Y!=null&&Y.replace?window.history.replaceState(null,"",Z):window.history.pushState(null,"",Z);const L=await fg(D,Ve,sg);if(f(L),O(!1),!(Y!=null&&Y.skipScroll)){const hn=window.location.hash.slice(1);hn?requestAnimationFrame(()=>{const jn=document.getElementById(hn);jn&&jn.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);G.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&Ve.some(Y=>Y.id===D)){const Y=Ko(D);window.history.replaceState(null,"",Y),B(D,{replace:!0})}else{const Y=Ko(r);window.history.replaceState(null,"",Y),H1.then(Z=>{f(Z),O(!1)})}},[]),G.useEffect(()=>{const D=()=>{const Y=U1(window.location.pathname);Y&&Y!==r&&B(Y,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[r,B]);const H=G.useRef(null),[R,x]=G.useState(()=>{var Y,Z;if(typeof document>"u")return"light";if(document.documentElement.classList.contains("dark"))return"dark";const D=((Y=ui.theme)==null?void 0:Y.mode)||"auto";return D==="dark"?"dark":D==="light"?"light":(Z=window.matchMedia)!=null&&Z.call(window,"(prefers-color-scheme: dark)").matches?"dark":"light"});G.useEffect(()=>{const D=new MutationObserver(()=>{const Y=document.documentElement.classList.contains("dark");x(Y?"dark":"light")});return D.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>D.disconnect()},[]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{H.current||(H.current=(await import(Z)).default);const L=H.current;if(Y)return;const hn=R==="dark",jn=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";L.initialize({startOnLoad:!1,theme:hn?"dark":"default",fontFamily:jn,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let w=0;w<D.length;w++){const Cn=D[w],Wn=Cn.getAttribute("data-mermaid");if(Wn)try{const Mn=atob(Wn),{svg:In}=await L.render(`tome-mermaid-${w}-${Date.now()}`,Mn);Y||(Cn.innerHTML=In)}catch(Mn){console.warn("[tome] Mermaid render failed:",Mn),Cn.textContent="Diagram rendering failed",Cn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(L){console.warn("[tome] Failed to load mermaid from CDN:",L),D.forEach(hn=>{hn.textContent="Failed to load diagram renderer",hn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{Y=!0}},[p,A,R]),G.useEffect(()=>{if(A)return;const D=document.querySelectorAll(".tome-content pre"),Y=[];return D.forEach(Z=>{if(Z.querySelector(".tome-copy-btn"))return;const L=document.createElement("button");L.className="tome-copy-btn",L.textContent="Copy",L.addEventListener("click",async()=>{const hn=Z.querySelector("code");if(hn)try{await navigator.clipboard.writeText(hn.textContent||""),L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},2e3)}catch{L.textContent="Failed",setTimeout(()=>{L.textContent="Copy"},2e3)}}),Z.appendChild(L),Y.push(L)}),()=>{Y.forEach(Z=>Z.remove())}},[p,A]);const V=Ve.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),C=Ve.find(D=>D.id===r),F=s1(C),J=o1(ui.editLink,C==null?void 0:C.filePath),yn=(C==null?void 0:C.locale)||(Zo==null?void 0:Zo.defaultLocale)||"en",tn="ltr";return G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]").length>0;if(!ui.math&&!D)return;const Y="tome-katex-css";if(document.getElementById(Y))return;const Z=document.createElement("link");Z.id=Y,Z.rel="stylesheet",Z.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",Z.crossOrigin="anonymous",document.head.appendChild(Z)},[p,A]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const L=(await import(Z)).default;if(Y)return;for(const hn of D){const jn=hn.getAttribute("data-math");if(jn)try{const w=atob(jn),Cn=hn.classList.contains("tome-math-block");L.render(w,hn,{displayMode:Cn,throwOnError:!1})}catch(w){console.warn("[tome] KaTeX render failed:",w)}}}catch(L){console.warn("[tome] Failed to load KaTeX from CDN:",L)}})(),()=>{Y=!0}},[p,A]),o.jsxs(o.Fragment,{children:[o.jsx("style",{children:B1}),o.jsx(i1,{config:ui,navigation:r1,currentPageId:r,pageHtml:p!=null&&p.isMdx?void 0:A?"":(p==null?void 0:p.html)||"<p>Page not found</p>",pageComponent:p!=null&&p.isMdx?p.component:void 0,mdxComponents:C1,pageTitle:(p==null?void 0:p.frontmatter.title)||(A?"":"Not Found"),pageDescription:p==null?void 0:p.frontmatter.description,headings:(p==null?void 0:p.headings)||[],tocEnabled:(p==null?void 0:p.frontmatter.toc)!==!1,editUrl:J,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:p!=null&&p.isMdx||p==null?void 0:p.changelogEntries,onNavigate:B,allPages:V,docContext:g1,versioning:void 0,currentVersion:F,basePath:Tu,isDraft:((cn=C==null?void 0:C.frontmatter)==null?void 0:cn.draft)===!0,dir:tn,i18n:void 0,currentLocale:yn,overrides:m1})]})}const ag=document.getElementById("tome-root");ag&&Rm.createRoot(ag).render(o.jsx(G1,{}));
