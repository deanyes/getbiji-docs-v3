 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kd;function T1(){if(kd)return nn;kd=1;var r=Symbol.for("react.transitional.element"),T=Symbol.for("react.portal"),h=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),O=Symbol.for("react.consumer"),U=Symbol.for("react.context"),H=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),X=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),F=Symbol.iterator;function J(g){return g===null||typeof g!="object"?null:(g=F&&g[F]||g["@@iterator"],typeof g=="function"?g:null)}var yn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},tn=Object.assign,cn={};function D(g,_,w){this.props=g,this.context=_,this.refs=cn,this.updater=w||yn}D.prototype.isReactComponent={},D.prototype.setState=function(g,_){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,_,"setState")},D.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Y(){}Y.prototype=D.prototype;function Z(g,_,w){this.props=g,this.context=_,this.refs=cn,this.updater=w||yn}var L=Z.prototype=new Y;L.constructor=Z,tn(L,D.prototype),L.isPureReactComponent=!0;var pn=Array.isArray;function jn(){}var N={H:null,A:null,T:null,S:null},Cn=Object.prototype.hasOwnProperty;function Wn(g,_,w){var k=w.ref;return{$$typeof:r,type:g,key:_,ref:k!==void 0?k:null,props:w}}function Mn(g,_){return Wn(g.type,_,g.props)}function In(g){return typeof g=="object"&&g!==null&&g.$$typeof===r}function Hn(g){var _={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(w){return _[w]})}var Ot=/\/+/g;function on(g,_){return typeof g=="object"&&g!==null&&g.key!=null?Hn(""+g.key):_.toString(36)}function yt(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(jn,jn):(g.status="pending",g.then(function(_){g.status==="pending"&&(g.status="fulfilled",g.value=_)},function(_){g.status==="pending"&&(g.status="rejected",g.reason=_)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function j(g,_,w,k,$){var un=typeof g;(un==="undefined"||un==="boolean")&&(g=null);var vn=!1;if(g===null)vn=!0;else switch(un){case"bigint":case"string":case"number":vn=!0;break;case"object":switch(g.$$typeof){case r:case T:vn=!0;break;case X:return vn=g._init,j(vn(g._payload),_,w,k,$)}}if(vn)return $=$(g),vn=k===""?"."+on(g,0):k,pn($)?(w="",vn!=null&&(w=vn.replace(Ot,"$&/")+"/"),j($,_,w,"",function(Ze){return Ze})):$!=null&&(In($)&&($=Mn($,w+($.key==null||g&&g.key===$.key?"":(""+$.key).replace(Ot,"$&/")+"/")+vn)),_.push($)),1;vn=0;var Pn=k===""?".":k+":";if(pn(g))for(var Nn=0;Nn<g.length;Nn++)k=g[Nn],un=Pn+on(k,Nn),vn+=j(k,_,w,un,$);else if(Nn=J(g),typeof Nn=="function")for(g=Nn.call(g),Nn=0;!(k=g.next()).done;)k=k.value,un=Pn+on(k,Nn++),vn+=j(k,_,w,un,$);else if(un==="object"){if(typeof g.then=="function")return j(yt(g),_,w,k,$);throw _=String(g),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return vn}function B(g,_,w){if(g==null)return g;var k=[],$=0;return j(g,k,"","",function(un){return _.call(w,un,$++)}),k}function W(g){if(g._status===-1){var _=g._result;_=_(),_.then(function(w){(g._status===0||g._status===-1)&&(g._status=1,g._result=w)},function(w){(g._status===0||g._status===-1)&&(g._status=2,g._result=w)}),g._status===-1&&(g._status=0,g._result=_)}if(g._status===1)return g._result.default;throw g._result}var sn=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},Tn={map:B,forEach:function(g,_,w){B(g,function(){_.apply(this,arguments)},w)},count:function(g){var _=0;return B(g,function(){_++}),_},toArray:function(g){return B(g,function(_){return _})||[]},only:function(g){if(!In(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return nn.Activity=C,nn.Children=Tn,nn.Component=D,nn.Fragment=h,nn.Profiler=A,nn.PureComponent=Z,nn.StrictMode=s,nn.Suspense=R,nn.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=N,nn.__COMPILER_RUNTIME={__proto__:null,c:function(g){return N.H.useMemoCache(g)}},nn.cache=function(g){return function(){return g.apply(null,arguments)}},nn.cacheSignal=function(){return null},nn.cloneElement=function(g,_,w){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var k=tn({},g.props),$=g.key;if(_!=null)for(un in _.key!==void 0&&($=""+_.key),_)!Cn.call(_,un)||un==="key"||un==="__self"||un==="__source"||un==="ref"&&_.ref===void 0||(k[un]=_[un]);var un=arguments.length-2;if(un===1)k.children=w;else if(1<un){for(var vn=Array(un),Pn=0;Pn<un;Pn++)vn[Pn]=arguments[Pn+2];k.children=vn}return Wn(g.type,$,k)},nn.createContext=function(g){return g={$$typeof:U,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:O,_context:g},g},nn.createElement=function(g,_,w){var k,$={},un=null;if(_!=null)for(k in _.key!==void 0&&(un=""+_.key),_)Cn.call(_,k)&&k!=="key"&&k!=="__self"&&k!=="__source"&&($[k]=_[k]);var vn=arguments.length-2;if(vn===1)$.children=w;else if(1<vn){for(var Pn=Array(vn),Nn=0;Nn<vn;Nn++)Pn[Nn]=arguments[Nn+2];$.children=Pn}if(g&&g.defaultProps)for(k in vn=g.defaultProps,vn)$[k]===void 0&&($[k]=vn[k]);return Wn(g,un,$)},nn.createRef=function(){return{current:null}},nn.forwardRef=function(g){return{$$typeof:H,render:g}},nn.isValidElement=In,nn.lazy=function(g){return{$$typeof:X,_payload:{_status:-1,_result:g},_init:W}},nn.memo=function(g,_){return{$$typeof:x,type:g,compare:_===void 0?null:_}},nn.startTransition=function(g){var _=N.T,w={};N.T=w;try{var k=g(),$=N.S;$!==null&&$(w,k),typeof k=="object"&&k!==null&&typeof k.then=="function"&&k.then(jn,sn)}catch(un){sn(un)}finally{_!==null&&w.types!==null&&(_.types=w.types),N.T=_}},nn.unstable_useCacheRefresh=function(){return N.H.useCacheRefresh()},nn.use=function(g){return N.H.use(g)},nn.useActionState=function(g,_,w){return N.H.useActionState(g,_,w)},nn.useCallback=function(g,_){return N.H.useCallback(g,_)},nn.useContext=function(g){return N.H.useContext(g)},nn.useDebugValue=function(){},nn.useDeferredValue=function(g,_){return N.H.useDeferredValue(g,_)},nn.useEffect=function(g,_){return N.H.useEffect(g,_)},nn.useEffectEvent=function(g){return N.H.useEffectEvent(g)},nn.useId=function(){return N.H.useId()},nn.useImperativeHandle=function(g,_,w){return N.H.useImperativeHandle(g,_,w)},nn.useInsertionEffect=function(g,_){return N.H.useInsertionEffect(g,_)},nn.useLayoutEffect=function(g,_){return N.H.useLayoutEffect(g,_)},nn.useMemo=function(g,_){return N.H.useMemo(g,_)},nn.useOptimistic=function(g,_){return N.H.useOptimistic(g,_)},nn.useReducer=function(g,_,w){return N.H.useReducer(g,_,w)},nn.useRef=function(g){return N.H.useRef(g)},nn.useState=function(g){return N.H.useState(g)},nn.useSyncExternalStore=function(g,_,w){return N.H.useSyncExternalStore(g,_,w)},nn.useTransition=function(){return N.H.useTransition()},nn.version="19.2.4",nn}var Qd;function Jo(){return Qd||(Qd=1,Lo.exports=T1()),Lo.exports}var G=Jo();const i0=S1(G);var Yo={exports:{}},ii={},ko={exports:{}},Qo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vd;function E1(){return Vd||(Vd=1,(function(r){function T(j,B){var W=j.length;j.push(B);n:for(;0<W;){var sn=W-1>>>1,Tn=j[sn];if(0<A(Tn,B))j[sn]=B,j[W]=Tn,W=sn;else break n}}function h(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var B=j[0],W=j.pop();if(W!==B){j[0]=W;n:for(var sn=0,Tn=j.length,g=Tn>>>1;sn<g;){var _=2*(sn+1)-1,w=j[_],k=_+1,$=j[k];if(0>A(w,W))k<Tn&&0>A($,w)?(j[sn]=$,j[k]=W,sn=k):(j[sn]=w,j[_]=W,sn=_);else if(k<Tn&&0>A($,W))j[sn]=$,j[k]=W,sn=k;else break n}}return B}function A(j,B){var W=j.sortIndex-B.sortIndex;return W!==0?W:j.id-B.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;r.unstable_now=function(){return O.now()}}else{var U=Date,H=U.now();r.unstable_now=function(){return U.now()-H}}var R=[],x=[],X=1,C=null,F=3,J=!1,yn=!1,tn=!1,cn=!1,D=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function L(j){for(var B=h(x);B!==null;){if(B.callback===null)s(x);else if(B.startTime<=j)s(x),B.sortIndex=B.expirationTime,T(R,B);else break;B=h(x)}}function pn(j){if(tn=!1,L(j),!yn)if(h(R)!==null)yn=!0,jn||(jn=!0,Hn());else{var B=h(x);B!==null&&yt(pn,B.startTime-j)}}var jn=!1,N=-1,Cn=5,Wn=-1;function Mn(){return cn?!0:!(r.unstable_now()-Wn<Cn)}function In(){if(cn=!1,jn){var j=r.unstable_now();Wn=j;var B=!0;try{n:{yn=!1,tn&&(tn=!1,Y(N),N=-1),J=!0;var W=F;try{t:{for(L(j),C=h(R);C!==null&&!(C.expirationTime>j&&Mn());){var sn=C.callback;if(typeof sn=="function"){C.callback=null,F=C.priorityLevel;var Tn=sn(C.expirationTime<=j);if(j=r.unstable_now(),typeof Tn=="function"){C.callback=Tn,L(j),B=!0;break t}C===h(R)&&s(R),L(j)}else s(R);C=h(R)}if(C!==null)B=!0;else{var g=h(x);g!==null&&yt(pn,g.startTime-j),B=!1}}break n}finally{C=null,F=W,J=!1}B=void 0}}finally{B?Hn():jn=!1}}}var Hn;if(typeof Z=="function")Hn=function(){Z(In)};else if(typeof MessageChannel<"u"){var Ot=new MessageChannel,on=Ot.port2;Ot.port1.onmessage=In,Hn=function(){on.postMessage(null)}}else Hn=function(){D(In,0)};function yt(j,B){N=D(function(){j(r.unstable_now())},B)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Cn=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return F},r.unstable_next=function(j){switch(F){case 1:case 2:case 3:var B=3;break;default:B=F}var W=F;F=B;try{return j()}finally{F=W}},r.unstable_requestPaint=function(){cn=!0},r.unstable_runWithPriority=function(j,B){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var W=F;F=j;try{return B()}finally{F=W}},r.unstable_scheduleCallback=function(j,B,W){var sn=r.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?sn+W:sn):W=sn,j){case 1:var Tn=-1;break;case 2:Tn=250;break;case 5:Tn=1073741823;break;case 4:Tn=1e4;break;default:Tn=5e3}return Tn=W+Tn,j={id:X++,callback:B,priorityLevel:j,startTime:W,expirationTime:Tn,sortIndex:-1},W>sn?(j.sortIndex=W,T(x,j),h(R)===null&&j===h(x)&&(tn?(Y(N),N=-1):tn=!0,yt(pn,W-sn))):(j.sortIndex=Tn,T(R,j),yn||J||(yn=!0,jn||(jn=!0,Hn()))),j},r.unstable_shouldYield=Mn,r.unstable_wrapCallback=function(j){var B=F;return function(){var W=F;F=B;try{return j.apply(this,arguments)}finally{F=W}}}})(Qo)),Qo}var Xd;function z1(){return Xd||(Xd=1,ko.exports=E1()),ko.exports}var Vo={exports:{}},ft={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zd;function M1(){if(Zd)return ft;Zd=1;var r=Jo();function T(R){var x="https://react.dev/errors/"+R;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var X=2;X<arguments.length;X++)x+="&args[]="+encodeURIComponent(arguments[X])}return"Minified React error #"+R+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(){}var s={d:{f:h,r:function(){throw Error(T(522))},D:h,C:h,L:h,m:h,X:h,S:h,M:h},p:0,findDOMNode:null},A=Symbol.for("react.portal");function O(R,x,X){var C=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:A,key:C==null?null:""+C,children:R,containerInfo:x,implementation:X}}var U=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function H(R,x){if(R==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return ft.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,ft.createPortal=function(R,x){var X=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(T(299));return O(R,x,null,X)},ft.flushSync=function(R){var x=U.T,X=s.p;try{if(U.T=null,s.p=2,R)return R()}finally{U.T=x,s.p=X,s.d.f()}},ft.preconnect=function(R,x){typeof R=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,s.d.C(R,x))},ft.prefetchDNS=function(R){typeof R=="string"&&s.d.D(R)},ft.preinit=function(R,x){if(typeof R=="string"&&x&&typeof x.as=="string"){var X=x.as,C=H(X,x.crossOrigin),F=typeof x.integrity=="string"?x.integrity:void 0,J=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;X==="style"?s.d.S(R,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:C,integrity:F,fetchPriority:J}):X==="script"&&s.d.X(R,{crossOrigin:C,integrity:F,fetchPriority:J,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},ft.preinitModule=function(R,x){if(typeof R=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var X=H(x.as,x.crossOrigin);s.d.M(R,{crossOrigin:X,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&s.d.M(R)},ft.preload=function(R,x){if(typeof R=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var X=x.as,C=H(X,x.crossOrigin);s.d.L(R,X,{crossOrigin:C,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},ft.preloadModule=function(R,x){if(typeof R=="string")if(x){var X=H(x.as,x.crossOrigin);s.d.m(R,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:X,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else s.d.m(R)},ft.requestFormReset=function(R){s.d.r(R)},ft.unstable_batchedUpdates=function(R,x){return R(x)},ft.useFormState=function(R,x,X){return U.H.useFormState(R,x,X)},ft.useFormStatus=function(){return U.H.useHostTransitionStatus()},ft.version="19.2.4",ft}var Kd;function _1(){if(Kd)return Vo.exports;Kd=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(T){console.error(T)}}return r(),Vo.exports=M1(),Vo.exports}/**
 * @license React
...
![iOS 系统文件选择器界面，标题为「最近项目」，列表中显示多个音视频文件（包括录音、录屏、视频等），可选择要导入的文件](/getbiji-docs-v3/images/PyMjbDeyCoI71IxqO3mcFQdxn6i.jpg)
...
![iPhone 语音备忘录 App 界面，显示录音列表，某条录音的「...」菜单已展开，「分享」选项用红框高亮标注，红色箭头指向该按钮](/getbiji-docs-v3/images/Vs1RbnO2OoH6bFx8tRXc5azYnqg.jpg)

2. 在分享列表里选择 Get 笔记。如果没看到，滑到最右边「更多」里找

![iOS 系统分享面板，显示录音文件信息（例会，录音，3.7 MB），应用列表中 Get 笔记图标用红框高亮标注，红色箭头指向该图标](/getbiji-docs-v3/images/Ecd4bIYaEoGMyzxDZfwcWH1mnqs.jpg)

### 从微信导入音频

1. 在微信中，点击音频文件的「...」，选择「用其他应用打开」

![微信文件传输助手聊天界面，显示多个文件消息，其中一条音频文件「例会.m4a（3.55MB）」用红框高亮标注](/getbiji-docs-v3/images/MTMNbeewUo2QlsxrwPwcTrg1nKd.jpg)
...
![Get 笔记 App 已接收导入的音频文件，显示笔记标题和处理状态](/getbiji-docs-v3/images/DCnKbSt0hoY8kwxvMyxcD4YVnQc.jpg)
...
`,Eu=(ui.basePath||"/").replace(/\/$/,"");function Bm(r){return o0(r,Eu,Xe)}function Ko(r){return cm(r,Eu,Xe)}const r0=sm(window.location.pathname,window.location.hash,Xe,Eu,o0),Hm=s0(r0,Xe,f0);function Gm(){var cn;const[r,T]=G.useState(r0),[h,s]=G.useState(null),[A,O]=G.useState(!0),U=G.useCallback(async(D,Y)=>{O(!0),T(D);const Z=Ko(D);Y!=null&&Y.replace?window.history.replaceState(null,"",Z):window.history.pushState(null,"",Z);const L=await s0(D,Xe,f0);if(s(L),O(!1),!(Y!=null&&Y.skipScroll)){const pn=window.location.hash.slice(1);pn?requestAnimationFrame(()=>{const jn=document.getElementById(pn);jn&&jn.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);G.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&Xe.some(Y=>Y.id===D)){const Y=Ko(D);window.history.replaceState(null,"",Y),U(D,{replace:!0})}else{const Y=Ko(r);window.history.replaceState(null,"",Y),Hm.then(Z=>{s(Z),O(!1)})}},[]),G.useEffect(()=>{const D=()=>{const Y=Bm(window.location.pathname);Y&&Y!==r&&U(Y,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[r,U]);const H=G.useRef(null),[R,x]=G.useState(()=>{var Y,Z;if(typeof document>"u")return"light";if(document.documentElement.classList.contains("dark"))return"dark";const D=((Y=ui.theme)==null?void 0:Y.mode)||"auto";return D==="dark"?"dark":D==="light"?"light":(Z=window.matchMedia)!=null&&Z.call(window,"(prefers-color-scheme: dark)").matches?"dark":"light"});G.useEffect(()=>{const D=new MutationObserver(()=>{const Y=document.documentElement.classList.contains("dark");x(Y?"dark":"light")});return D.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>D.disconnect()},[]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{H.current||(H.current=(await import(Z)).default);const L=H.current;if(Y)return;const pn=R==="dark",jn=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";L.initialize({startOnLoad:!1,theme:pn?"dark":"default",fontFamily:jn,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let N=0;N<D.length;N++){const Cn=D[N],Wn=Cn.getAttribute("data-mermaid");if(Wn)try{const Mn=atob(Wn),{svg:In}=await L.render(`tome-mermaid-${N}-${Date.now()}`,Mn);Y||(Cn.innerHTML=In)}catch(Mn){console.warn("[tome] Mermaid render failed:",Mn),Cn.textContent="Diagram rendering failed",Cn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(L){console.warn("[tome] Failed to load mermaid from CDN:",L),D.forEach(pn=>{pn.textContent="Failed to load diagram renderer",pn.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{Y=!0}},[h,A,R]),G.useEffect(()=>{if(A)return;const D=document.querySelectorAll(".tome-content pre"),Y=[];return D.forEach(Z=>{if(Z.querySelector(".tome-copy-btn"))return;const L=document.createElement("button");L.className="tome-copy-btn",L.textContent="Copy",L.addEventListener("click",async()=>{const pn=Z.querySelector("code");if(pn)try{await navigator.clipboard.writeText(pn.textContent||""),L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},2e3)}catch{L.textContent="Failed",setTimeout(()=>{L.textContent="Copy"},2e3)}}),Z.appendChild(L),Y.push(L)}),()=>{Y.forEach(Z=>Z.remove())}},[h,A]);const X=Xe.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),C=Xe.find(D=>D.id===r),F=fm(C),J=om(ui.editLink,C==null?void 0:C.filePath),yn=(C==null?void 0:C.locale)||(Zo==null?void 0:Zo.defaultLocale)||"en",tn="ltr";return G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]").length>0;if(!ui.math&&!D)return;const Y="tome-katex-css";if(document.getElementById(Y))return;const Z=document.createElement("link");Z.id=Y,Z.rel="stylesheet",Z.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",Z.crossOrigin="anonymous",document.head.appendChild(Z)},[h,A]),G.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]");if(D.length===0)return;let Y=!1;const Z="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const L=(await import(Z)).default;if(Y)return;for(const pn of D){const jn=pn.getAttribute("data-math");if(jn)try{const N=atob(jn),Cn=pn.classList.contains("tome-math-block");L.render(N,pn,{displayMode:Cn,throwOnError:!1})}catch(N){console.warn("[tome] KaTeX render failed:",N)}}}catch(L){console.warn("[tome] Failed to load KaTeX from CDN:",L)}})(),()=>{Y=!0}},[h,A]),o.jsxs(o.Fragment,{children:[o.jsx("style",{children:Um}),o.jsx(im,{config:ui,navigation:rm,currentPageId:r,pageHtml:h!=null&&h.isMdx?void 0:A?"":(h==null?void 0:h.html)||"<p>Page not found</p>",pageComponent:h!=null&&h.isMdx?h.component:void 0,mdxComponents:Cm,pageTitle:(h==null?void 0:h.frontmatter.title)||(A?"":"Not Found"),pageDescription:h==null?void 0:h.frontmatter.description,headings:(h==null?void 0:h.headings)||[],tocEnabled:(h==null?void 0:h.frontmatter.toc)!==!1,editUrl:J,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:h!=null&&h.isMdx||h==null?void 0:h.changelogEntries,onNavigate:U,allPages:X,docContext:gm,versioning:void 0,currentVersion:F,basePath:Eu,isDraft:((cn=C==null?void 0:C.frontmatter)==null?void 0:cn.draft)===!0,dir:tn,i18n:void 0,currentLocale:yn,overrides:mm})]})}const a0=document.getElementById("tome-root");a0&&R1.createRoot(a0).render(o.jsx(Gm,{}));
