const n={frontmatter:{title:"分享和团队管理",description:"将知识库公开分享或设为团队模式，支持成员管理、权限分配和订阅他人知识库",hidden:!1,toc:!0,draft:!1},html:`<h1 id="分享和团队管理"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#分享和团队管理"><span class="icon icon-link"></span></a>分享和团队管理</h1>
<p>把知识库分享给别人，或者组建团队一起维护。你可以把知识库公开让所有人看，也可以设为团队模式只让特定的人使用。</p>
<h2 id="是什么"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#是什么"><span class="icon icon-link"></span></a>是什么</h2>
<p>每个知识库默认是<strong>私密</strong>状态，只有自己能看到。如果你想让别人也能用你的知识库，需要手动设置分享权限。</p>
...
<h2 id="怎么分享"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#怎么分享"><span class="icon icon-link"></span></a>怎么分享</h2>
<h3 id="公开分享"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#公开分享"><span class="icon icon-link"></span></a>公开分享</h3>
...
<p><img src="/getbiji-docs-v3/images/FGmpbMg08o2EBvxSVsfc69cGnNe.jpg" alt="团队设置页面，显示「成员自动加入」开关，关闭时需管理员审核，打开时成员可直接加入"></p>
<p>其他成员点击链接后，会看到「申请加入知识库」按钮。管理员审核通过后，知识库会出现在成员的列表中。</p>
<p><img src="/getbiji-docs-v3/images/KsQdbmbcGo2kNAxRq7WctJuZnfI.jpg" alt="他人通过链接访问的团队知识库页面，显示「申请加入知识库」按钮"></p>
...
<p><img src="/getbiji-docs-v3/images/E4vvbxxc2oWXzix0YjQcxXjhnyd.jpg" alt="知识库详情页顶部成员入口显示红点通知，提示有新的加入申请待审核"></p>
...
<p><img src="/getbiji-docs-v3/images/Lj1ub7ugeoMpXAxB0N5ctQwYnSh.jpg" alt="成员角色设置页面，可将成员设置为「普通成员」或「管理员」，底部有「移出知识库」选项"></p>
...
<h2 id="订阅别人的知识库"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#订阅别人的知识库"><span class="icon icon-link"></span></a>订阅别人的知识库</h2>
...
<p><img src="/getbiji-docs-v3/images/B6ahbzjuZokVrmxE78ScLpKHnVe.jpg" alt="知识库列表页「精选」标签，展示官方推荐的优质知识库，可点击订阅"></p>
<p><img src="/getbiji-docs-v3/images/P987bN9gvosMABxmpoKcT0fincg.jpg" alt="已订阅的知识库出现在「我的」知识库列表中"></p>
...
<li><strong>团队适合长期协作</strong>：如果需要多人一起添加内容和管理，选「团队」模式</li>
<li><strong>关闭分享即失效</strong>：把分享权限改回「私密」，之前分享的链接就失效了，别人无法再访问</li>
<li><strong>订阅不占容量</strong>：订阅别人的知识库不会占用你自己的存储空间</li>
</ul>`,headings:[{depth:2,text:"是什么",id:"是什么"},{depth:2,text:"怎么分享",id:"怎么分享"},{depth:3,text:"公开分享",id:"公开分享"},{depth:4,text:"App 端",id:"app-端"},{depth:4,text:"网页端",id:"网页端"},{depth:4,text:"小程序端",id:"小程序端"},{depth:3,text:"团队协作",id:"团队协作"},{depth:4,text:"App 端",id:"app-端-1"},{depth:4,text:"审核成员申请",id:"审核成员申请"},{depth:4,text:"团队角色权限",id:"团队角色权限"},{depth:2,text:"订阅别人的知识库",id:"订阅别人的知识库"},{depth:3,text:"App 端",id:"app-端-2"},{depth:3,text:"网页端",id:"网页端-1"},{depth:2,text:"小技巧",id:"小技巧"}],raw:`
# 分享和团队管理
